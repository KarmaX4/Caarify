...
const FooterIllustrationsV1 = (props: FooterIllustrationsProp) => {
  ...
  if (!hidden) {
    return (
      <Fragment>
        {image1 || <Tree1Img height='400px' width="400px" alt='tree' src='/images/pages/auth-v1-tree.png' />}
        <MaskImg alt='mask' src={`/images/pages/auth-v1-mask-${theme.palette.mode}.png`} />
        {image2 || <Tree2Img  height='400px' width="400px" alt='tree-2' src='/images/pages/auth-v1-tree-2.png' />}
      </Fragment>
    )
  } else {
    return null
